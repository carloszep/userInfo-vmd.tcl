...
#|      -has to be tested to ensure that the last fragment, which has simName
#|       _ different from the global simName (sim folder), is well interpreted ;
#|    -changes/updates done :
#|      -incorporating functionality to write trajectories for selections of
#|       _ atoms according to selId specifications ;
#|    -previous changes :
#|      -reincorporated the call for tool coordMol ;
#|    -unfinished version ;
...
set userInfo_version 0.0.7
set userInfo_logFileName "log_userInfo-v.$userInfo_version.txt"
...
foreach tool [lsort [glob ${tclScriptPath}userInfo/tools/*.tcl]] {
  puts "loading tool $tool"
  source $tool
  }
